import {
  StoryPartOut, StoryPart, RoadmapTitle, Text, Subtitle,
} from "./privacy.style";
...
const PrivacyContainer = () => {
  return (
    <>
      ...
      <StoryPartOut>
        <StoryPart>
          <RoadmapTitle>PRIVACY</RoadmapTitle>
          <Text>
            ...
            Ipsum sit mattis nulla quam nulla. Gravida id gravida ac enim mauris id. Non pellentesque congue eget consectetur turpis. Sapien, dictum molestie sem tempor. Diam elit, orci, tincidunt aenean tempus. Quis velit eget ut tortor tellus. Sed vel, congue felis elit erat nam nibh orci.<br /><br />
          </Text>
